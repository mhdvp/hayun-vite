import Tympanogram from "./Tympanogram_box";
...
class TympanogramUI {
	...
	draw({ containerId = '#app' } = {}) {
		...
		this.rchart = new Tympanogram({ box: { container: this.rcontainer, width: 600, height: 360 }, side: 'R' })
		...
		this.lchart = new Tympanogram({ box: { container: this.lcontainer, width: 600, height: 360 }, dims, side: 'L' })
		// فراخوانی متد ایجاد اینپوت روی چارت اسپیچ
